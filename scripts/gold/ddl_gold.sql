...
The gold layer portrays a star schema, specifically representing
the final dimension and fact tables.

Each view performs transformations and combines data from the silver
layer to product a clean, enrished, and business-ready data set.
...
gc.cat AS category,
gc.subcat AS subcategory,
gc.maintenance,
pn.prd_cost AS cost,
pn.prd_line AS product_line,
pn.prd_start_dt AS start_date
FROM silver.crm_prd_info AS pn
LEFT JOIN silver.erp_px_cat_g1v2 AS gc
ON pn.cat_id = gc.id
